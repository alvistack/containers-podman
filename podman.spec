...
License: Apache-2.0
URL: https://github.com/podman-container-tools/podman/tags
...
Requires: buildah >= 1.44.0
Requires: catatonit
Requires: conmon
Requires: containernetworking-plugins
Requires: containers-common >= 0.68.0
Requires: iptables
Requires: oci-runtime
Requires: podman-aardvark-dns >= 2.0.0
Requires: podman-netavark >= 2.0.0
Requires: skopeo >= 1.23.0
Requires: tzdata
